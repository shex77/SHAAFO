...
def menu():
	...
	#INFORMATION OF USER
	print "~~~~~~~~~~~~~~~~~~~~~~~~"
	print "\x1b[32;1mAro×software/ Name >>"+namefb
	print "\x1b[34;1mAro×software/ ID >>"+id
	print '\x1b[33;1mAro×software/ TotalSub >>'+subid
	print "~~~~~~~~~~~~~~~~~~~~~~~~"
	print ""
	print "===================="
...
def option():
	unikers = raw_input("\n\x1b[31;1mAro\x1b[37;1mSoftware>>\x1b[33;1m")
	if unikers =="":
